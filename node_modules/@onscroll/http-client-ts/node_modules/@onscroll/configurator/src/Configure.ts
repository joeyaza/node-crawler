...
export function Configure (configPropertyName: string) {
    ...
    return function (target: any, key: string) {
        ...
        try {
            ...
            target[key] = _.reduce(_.split(configPropertyName, "."), (reduced, key) => {
            ...
            throw new InvalidConfigException(exception.message);
